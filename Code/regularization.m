...
fprintf('\nsingle varaible...\n')
TX1 = [ones(n, 1), tx1];
costFunctionCal(TX1, ty,n, theta1)
p1 = prediction(TX1, theta1, 0.2);
[tp1, fn1, fp1, tn1] = confusionMatrixCal(ty, p1)

%%%%%Two Variables%%%%
fprintf('Two varaibles...\n')
TX2 = [ones(n, 1), tx1,tx2];
costFunctionCal(TX2, ty,n, theta2)
p2 = prediction(TX2, theta2, 0.4);
[tp2, fn2, fp2, tn2] = confusionMatrixCal(ty, p2)

%%% Three Variables%%%
fprintf('Three varaibles...\n')
TX3 = [ones(n, 1), tx1,tx2,tx3];
costFunctionCal(TX3, ty,n, theta3)
p3 = prediction(TX3, theta3, 0.2);
[tp3, fn3, fp3, tn3] = confusionMatrixCal(ty, p3)

%%%Four Variables%%%%
fprintf('Four varaibles...\n')
TX4 = [ones(n, 1), tx1,tx2,tx3,tx4];
costFunctionCal(TX4, ty,n, theta4)
p4 = prediction(TX4, theta4, 0.15);
[tp4, fn4, fp4, tn4] = confusionMatrixCal(ty, p4)
