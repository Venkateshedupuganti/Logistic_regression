...
fprintf('Logistic Regression with Three variables');
x =[ones(m,1), x1, x2,x3];
[theta , min_cost] = fminunc(@(th)(costFunctionCal(x, y, m, th)), zeros(4, 1), options);
fprintf('theta values: \n');
fprintf(' %f \n', theta);
fprintf('Minimum Cost:\t');
fprintf('%f\n',min_cost);

cx = [ones(c,1),cx1,cx2,cx3];
